...
$array | Export-Csv -Path C:\Users\prueba\Desktop\test.csv -NoTypeInformation # Aqui se genera archivo csv
...
$Username = "frankyfcfm@gmail.com"; # Aqui va tu cuenta de gmail

$Password = "xxxx xxxx xxxx xxxx";      # Aqui va tu password de aplicación

$path = "C:\Users\prueba\Desktop\test.csv";       # Aqui va la ruta de el archivo csv generado previamente
...
function Send-ToEmail([string]$email, [string]$attachmentpath){
    ...
    $message.From = "frankyfcfm@gmail.com"; # Aqui va tu cuenta de gmail.

    $message.To.Add($email);

    $message.Subject = "<INFO DE EQUIPO>."; #Asunto del correo

    $message.Body = "Envió de Informacion de Equipo"; #Cuerpo o Mensaje del correo.
...
Send-ToEmail  -email "mar225tha73@gmail.com" -attachmentpath $path; # En email pones el destinatario
